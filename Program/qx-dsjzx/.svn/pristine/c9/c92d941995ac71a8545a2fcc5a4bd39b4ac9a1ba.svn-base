...
namespace Models
{
    ...
    public partial class datatask
    {
           ...
           /// Nullable:True
           /// </summary>           
           public string ModelingWay {get;set;}
           ...
           /// Nullable:True
           /// </summary>           
           public string AutoTriggerCondition {get;set;}
